...
/* @var $model backend\models\FundraiserSchemeCommentSearch */
...
<div class="fundraiser-scheme-comment-search">
    ...
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'user_id')->dropdownList($userList,['prompt'=>'Select One...']) ?>
        </div>
        <div class="col-md-3">
            <?= $form->field($model, 'comment') ?>
        </div>
        <div class="col-md-3">
            <?= $form->field($model, 'fundraiser_id') ?>
        </div>
    </div>
    <div class="row">
        <?php 
