...
$fundraiserScheme = FundraiserScheme::find()->where(['status'=>1])->all();
...
<div class="donation-search">
    ...
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'fundraiser_id')->dropdownList($schemeList,['prompt'=>'Select One']) ?>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <?php echo $form->field($model, 'show_donor_information')->dropdownList($list,['prompt'=>'Select One']) ?>
        </div>
        <div class="col-md-3">
            <?php 
            if($model->from_date){
